...
function langEN()
{
  location.replace("../pages/something.php?lang=<?php echo "EN" ?>");
}
function langTR()
{
  location.replace("../pages/something?lang=<?php echo "TR" ?>");
}
  </script>
  </head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <div class="collapse navbar-collapse" id="navbarText">
   ...
   <option   <?php turkishSelected(); ?>  onclick="langTR()">Türkçe</option>
    ...
    <div class="teamMainDiv">



       <img src="../img/Gcorp.png" alt="avatar"/>

       <p class="innertitleTeams Company"></p >  <?php selectLanguange("Company","Şirket");  ?></p>

        <h4 class="innerText">
         <?php selectLanguange(" Öde is a product of Gurqiti Corp©","Öde Gurqiti Corp©'un bir ürünüdür");  ?>
       </h4>
    ...
    <div class="teamMainDiv">
        ...
        <img src="../img/developer.jpg" class="avatar"  alt="avatar"/>
 
        <p class="innertitleTeams Company"></p><?php selectLanguange("Design Team","Tasarım Ekibi");  ?></p>
     ...
     <div class="teamMainDiv">
        ...
        <p class="innertitleTeams Company"></p >  <?php selectLanguange("Developement Team","Gelitirici Ekip");  ?></p>
 
         <h4 class="innerText">
          <?php selectLanguange(" Again,Fati Gurqiti","Tabi ki,Fati Gurqiti");  ?>
        </h4>
