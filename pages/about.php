...
function langEN()
{
  location.replace("../pages/about.php?lang=<?php echo "EN" ?>");
}
function langTR()
{
  location.replace("../pages/about.php?lang=<?php echo "TR" ?>");
}
  </script>
 ...
 <div class="collapse navbar-collapse" id="navbarText">
   ...
   <option   <?php turkishSelected(); ?>  onclick="langTR()">Türkçe</option>
     ...
     <div>
        ...
        <div class="left">
            <img src="../img/logoLargeWhite.png" class="logoLarge"/>
        </div>

        <div class="right">
            <p class="title What_is_Ode" ><?php selectLanguange("What is Öde ?","Öde nedir")  ?></p>
        <h4 class="innerText">
            <?php selectLanguange("Öde is a mobile app developed by Gurqiti Corp that is ","Öde,borçlarınızı takip etmenize yarayan")  ?><br><?php selectLanguange("aiming to help you keep the track of debts and loans","Gurqiti Corp tarafından geliştirilmiş bir uygulamadır.")  ?>
        </h4>
     ...
     <div class="aboutDiv">
         <hr class="firstLine whiteAbout">

         <p class="innertitle"><?php selectLanguange(" What can you do ?","Neler Yapabilirsiniz ?")  ?></p>

         <h4 class="innerText">
          <?php selectLanguange(" With Öde you can; view total amounts of debts and loans","Öde ile;borçlarınızı görüntüleyebilir,")  ?><br>
          <?php selectLanguange(" You can also view each of them one by one with the labels so that you don't get confused","herbirini etiketleriyle teker teker görebilirsiniz.")  ?>
        </h4>
    ...
    <div class="developedDiv">
        <hr class="firstLine whiteAbout" >

        <p class="innertitle"> <?php selectLanguange("Developers","Geliştiriciler")  ?></p>

        <h4 class="innerText">
          <?php selectLanguange("Öde app has been developed by the Gurqiti Corp","Öde Gurqiti Corp tarafından geliştirilmişitir.")  ?><br>
         <?php selectLanguange(" The team and the team leader was the almighty programmer Fati Gurqiti","Ekip ve ekip lideri yüce yazılımcı Fati Gurqiti")  ?>
       </h4>
    ...
    <div class="developedDiv">
        ...
        <p class="innertitle"> <?php selectLanguange("Meaning of Öde","Öde'nin anlamı")  ?></p>

        <h4 class="innerText">
          <?php selectLanguange("Öde means Pay up in Turkish","Öde yazıldığı gibi okunur")  ?><br>
          <?php selectLanguange("Which is the main purpose of us","Ki amacımız da bu")  ?>
       </h4>
